(function () {
  ...
  var PAGE_TRANSLATIONS = {
    en: {
      ...
      'optimizer.importSkillsGroup': 'Import skills',
      'optimizer.savedBuildsGroup': 'Saved builds',
      'optimizer.manageListGroup': 'Manage list',
      ...
      'deck.templatesSource':
        'Grand Live / Grand Concert templates based on uma.moe 2026-08-28 Class 6 statistics',
      'deck.templateUsage': '{0}% of Grand Live Class 6 decks',
    ...
    ja: {
      ...
      'optimizer.importSkillsGroup': 'スキルをインポート',
      'optimizer.savedBuildsGroup': '保存済みビルド',
      'optimizer.manageListGroup': 'リスト管理',
